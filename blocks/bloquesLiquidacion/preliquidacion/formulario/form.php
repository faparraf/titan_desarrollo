...
class Formulario {
    ...
    function formulario() {
       ...
       // --------------------------------------------------------------------------------------------------
		...
		$atributos ['tipoEtiqueta'] = 'inicio';
		$atributos ["leyenda"] = "PRELIQUIDACIONES";
        ...
        // ------------------Division para los botones-------------------------
                        ...
                        // -----------------CONTROL: Botón ----------------------------------------------------------------
                        $esteCampo = 'botonRegistrarPreliquidacion';
                        $atributos ["id"] = $esteCampo;
        ...
        $atributos ['cadena_sql'] = $this->miSql->getCadenaSql("buscarRegistrosDePreliquidacion");
        ...
        echo '<table id="tablaReporte" class="display" cellspacing="0" width="100%"> '
                 . '<thead style="display: table-row-group"><tr><th>'."NOMBRE".'</th><th>'."DESCRIPCIÓN".'</th> <th>'."FECHA INICIO".'</th> <th>'."FECHA FIN".'</th> <th>'."FECHA PRELIQUIDACIÓN".'</th><th>'."VER DETALLE".'</th><th>'."MODIFICAR".'</th><th>'."ESTADO".'</th></tr></thead>
