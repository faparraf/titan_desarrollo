		...
		echo $this->miFormulario->formulario ( $atributos );
		{
			...
			
			{
				...
				if ($_REQUEST ['mensaje'] == 'inserto') {
					...
					$mensaje = "Registro Preliquidación Satisfactorio <br> Nombre: <h4>" . $_REQUEST ['nombreRegistro'] . "</h4>".
				...
				if ($_REQUEST ['mensaje'] == 'modifico') {
					...
					$mensaje = "Modificacion Preliquidación Satisfactorio <br> Nombre: <h4>" . $_REQUEST ['nombreRegistro'] . "</h4>".
					"<br>Fecha Registro: " . date ( 'Y-m-d' );
